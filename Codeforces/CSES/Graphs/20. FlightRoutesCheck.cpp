...
void kosaraju(){
    ...
    if(cnt == 1){
        ...
        cout<<"NO"<<endl;
        cout<<sccs[1][0]<<" "<<sccs[0][0]<<endl;
        // print scc[1][0] and then scc[0][0] because you cannot visit a city from 2nd component to 1st component, but the reverse is true
        // the question wants us to print city a and b such that you cannot visit a to b
        //  cout<<sccs[1][0]<<" "<<sccs[0][0]<<endl;
    }
