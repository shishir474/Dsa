...
#NOTE: At the end of the day, the input array will be sorted. If u want to keep the input array intact, then make a copy of the input array and then call the helper function on that copy.