...
SC: O(n + m) - this is the space required to store the resultant merged array. We are not distortng the input arrays in this approach.
...
#NOTE: We are distorting the input arrays in this approach.
